        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-background-light dark:bg-surface-dark rounded-2xl border border-gray-100 dark:border-gray-800 p-8 flex flex-col gap-6 hover:shadow-xl transition-all duration-300">
              <a href="https://www.unesco.org/" target="_blank" rel="noopener noreferrer" className="w-full h-48 flex items-center justify-center bg-white dark:bg-white/5 rounded-xl p-8 border border-gray-100 dark:border-gray-700 overflow-hidden relative cursor-pointer group/img">
                <img
                  src="https://images.unsplash.com/photo-1596484552834-6a58f850e0a1?w=400&fit=crop"
                  alt="Partnership Image"
                  className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover/img:scale-110 transition-transform duration-700"
                />
                <span className="relative z-10 text-4xl font-black text-primary/40 group-hover/img:text-primary transition-colors">
                  UNESCO
                </span>
              </a>
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4">
                  <a href="https://www.unesco.org/" target="_blank" rel="noopener noreferrer" className="text-text-muted dark:text-gray-400 text-sm hover:text-primary transition-colors cursor-pointer">
                    Website
                  </a>
                </div>
              </div>
            ...
            <div className="group bg-background-light dark:bg-surface-dark rounded-2xl border border-gray-100 dark:border-gray-800 p-8 flex flex-col gap-6 hover:shadow-xl transition-all duration-300">
              <a href="https://www.undp.org/uzbekistan" target="_blank" rel="noopener noreferrer" className="w-full h-48 flex items-center justify-center bg-white dark:bg-white/5 rounded-xl p-8 border border-gray-100 dark:border-gray-700 overflow-hidden relative cursor-pointer group/img">
                <img
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4">
                  <a href="https://www.undp.org/uzbekistan" target="_blank" rel="noopener noreferrer" className="text-text-muted dark:text-gray-400 text-sm hover:text-primary transition-colors cursor-pointer">
                    Website
                  </a>
                </div>
              </div>
            ...
            <div className="group bg-background-light dark:bg-surface-dark rounded-2xl border border-gray-100 dark:border-gray-800 p-8 flex flex-col gap-6 hover:shadow-xl transition-all duration-300">
              <a href="https://www.worldbank.org/en/country/uzbekistan" target="_blank" rel="noopener noreferrer" className="w-full h-48 flex items-center justify-center bg-white dark:bg-white/5 rounded-xl p-8 border border-gray-100 dark:border-gray-700 overflow-hidden relative cursor-pointer group/img">
                <img
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4">
                  <a href="https://www.worldbank.org/en/country/uzbekistan" target="_blank" rel="noopener noreferrer" className="text-text-muted dark:text-gray-400 text-sm hover:text-primary transition-colors cursor-pointer">
                    Website
                  </a>
                </div>
              </div>
